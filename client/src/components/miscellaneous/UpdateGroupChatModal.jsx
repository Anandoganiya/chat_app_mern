...
const UpdateGroupChatModal = ({ fetchMessages, fetchAgain, setFetchAgain }) => {
  ...
  const handleAddUser = async (user1) => {
    ...
    if (selectedChat.groupAdmin._id !== user.data.data._id) {
      toast({
  ...
  const handleRemove = async (user1) => {
    ...
    // );
    // console.log(
    //   selectedChat.groupAdmin._id !== user.data.data._id &&
    //     user1._id !== user.data.data._id
    // );
    if (
      selectedChat.groupAdmin._id !== user.data.data._id &&
      user1._id !== user.data.data._id
    ...
    <>
      ...
      <Modal onClose={onClose} isOpen={isOpen} isCentered>
        ...
        <ModalContent>
          ...
          <ModalFooter>
            <Button
              onClick={() => handleRemove(user.data.data)}
              colorScheme="red"
            >
              Leave Group
            </Button>
