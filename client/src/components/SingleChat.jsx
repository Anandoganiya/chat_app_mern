...
const ENDPOINT = `${import.meta.env.VITE_APP_BASE_API}`; // "https://talk-a-tive.herokuapp.com"; -> After deployment
        ...
        <>
          ...
          >
            {loading ? (
              ...
              <div className="messages" style={{ height: "90%" }}>
